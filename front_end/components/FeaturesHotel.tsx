    ...
    return (
        <div className="text-body-lg mt-[20px] pb-[10px] text-secondary [&_ol]:mx-[20px] [&_ol]:gap-y-[5px] [&_h2]:mt-[30px] [&_h2]:mb-[10px] [&_ol]:my-[20px]  [&_ol]:list-decimal [&_ol]:gap-y-[10px]">
            ...
            <div>
                ...
                <br />
                <br />
                Here are some of the advantages of booking hotels with ixigo:
            </div>
            <ol>
                ...
                <li><strong>Pay at Hotel option available</strong><br />
                    Make your online hotel booking with ixigo and get the flexibility to pay at the property directly. </li>
                <li><strong>Collaborative wishlists</strong><br />
                    Plan your dream vacation together - With our collaborative wishlist feature, share your favourite properties with your travel mates and also let them add their own.</li>
                <li><strong>24x7 customer support</strong><br />
                    Need help? Get assistance from our Customer Service team for all your hotel reservation-related queries.</li>
            </ol>
            <h2><strong>How to search for cheap hotels on ixigo? </strong></h2>
            <p>
                ixigo offers a wide selection of hotels that cater to all types of budgets, making it easier for you to find the perfect accommodation that suits your needs.
                <br />
                <br />

                Here’s how you can search for cheap hotels with us -
            </p>
            <ol>
                <li>
                    Log in to the ixigo app. </li>
                <li>
                    Enter the destination you want to book for.</li>
                <li>
                    Choose check-in and check-out dates.</li>
                <li>Select the number of rooms and guests and hit ‘Search Hotels’.</li>
                <li>
                    Filter by price and sort the results from low to high. </li>
                <li>
                    Compare and choose from the hotel options. </li>
            </ol>
            <p>
